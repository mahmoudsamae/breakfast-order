...
const ORDER_SELECT =
  "id,order_number,customer_name,created_at,status,total_amount,pickup_date,order_items(id,product_id,menu_id,quantity,unit_price,products(name,category,image_url),menus(id,name,description,image_url,menu_items(product_id,quantity,products(name,category,image_url))))";
