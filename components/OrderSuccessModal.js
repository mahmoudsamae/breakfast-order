...
export default function OrderSuccessModal({ open, customerName, orderNumber, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-slate-950/55 p-0 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="max-h-[90dvh] w-full max-w-md overflow-y-auto overscroll-y-contain rounded-t-3xl bg-white p-5 text-center shadow-2xl sm:rounded-3xl sm:p-6 [-webkit-overflow-scrolling:touch]">
